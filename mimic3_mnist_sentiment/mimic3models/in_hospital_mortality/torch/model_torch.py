...
class LSTMRealTimeRegressor(torch.nn.Module):
    def __init__(self, input_dim, num_classes=2, num_hidden=16):
...
class LSTMRealTimeRegressor_energy(torch.nn.Module):
    def __init__(self, input_dim, num_classes=2, num_hidden=16):
        super(LSTMRealTimeRegressor_energy, self).__init__()
        self.input_dim = input_dim
        self.n_layers = 1
        ...
        self.fc1 = torch.nn.Linear(self.n_hidden * self.num_direction, 200)
        self.fc2 = torch.nn.Linear(200, 200)
        self.fc3 = torch.nn.Linear(200, 200)
        self.fc4 = torch.nn.Linear(200, num_classes)
