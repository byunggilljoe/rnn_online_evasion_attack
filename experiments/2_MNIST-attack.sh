...
CVDS=${3}
DATASET="mnist"
OPTION="--dataset ${DATASET} --k ${K} --t_start 0 --t_end 28 --no-eval_last --t_eval_start 0 --t_eval_end 28 --NUM_TEST_BATCH 5 --targeted"
# ITERS=50
ITERS=20
...
for trial in 0 1 2
do
    for eps in 0.02 0.04 0.08 0.15 0.30 0.60
    do
