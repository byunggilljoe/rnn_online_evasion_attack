...
if __name__ == "__main__":
    ...
    if model_name == 'baseline':
        ...
        net = SteeringAngleRegressor(-1, -1)
    ...
    if train != 0:
        ...
        dataset = UdacityDataset(dataset_path, ['HMB1', 'HMB2', 'HMB4', 'HMB5','HMB6'], composed, downsample_factor=DOWNSAMPLE_FACTOR)
        ...
        for epoch in range(epochs):
            ...
            for step, sample_batched in enumerate(train_generator):
                ...
                if step <= steps_per_epoch:
                    ...
                    print("steer max min:", batch_y.max(), batch_y.min())
    ...
    with torch.no_grad():
        ...
        test_dataset = UdacityDataset(dataset_path, ['testing'], test_composed, 'test', downsample_factor=DOWNSAMPLE_FACTOR)
